    ...
    <div className="max-w-5xl mx-auto px-4">
      ...
      <section className="text-center py-20">
        ...
        <p className="text-lg text-gray-500 max-w-2xl mx-auto mb-8">
          ImpactScore enables street vendors and underserved communities to
          access micro-loans using verified real-world activities stored on the
          Polygon blockchain.
        </p>
      ...
      <section className="grid md:grid-cols-3 gap-4 mb-16">
        {[
          ...
          >
            <div className={`text-3xl font-bold text-${t.color}-600 mb-1`}>
              {t.rate}
            </div>
      ...
      <section className="bg-indigo-600 rounded-3xl text-white text-center py-14 px-6 mb-16">
        <h2 className="text-3xl font-bold mb-3">
          Ready to build your Impact Score?
        </h2>
        <p className="text-indigo-200 mb-6">
          Join thousands of borrowers already on the platform.
        </p>
        <Link
          to="/signup"
